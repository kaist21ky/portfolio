						...
						<div class="inner">
							...
							<!-- Content -->
								<?php
									...
									$sql = "UPDATE altruistic SET success = 1 WHERE key_value = '$key_value'";
									...
									$sql2 = "UPDATE altruistic_success SET state = 2, match_time = '$success_time' WHERE altruistic_id = '$key_value'";
									...
									$state = 0;
									$trade_cycle = 0;
									$sql_f = "SELECT * FROM altruistic_success altruistic_id = '$key_value'";
									$result_f = mysqli_query($conn,$sql_f);
									while ($jb_row = mysqli_fetch_array( $result_f ) ) {
									...
									$sql3 = "UPDATE altruistic_success SET state = 2, match_time = '$success_time' WHERE sell_id = $buy_id, sell_name = $buy_name, sell_class = $buy_class, subject_name = $subject_name";
									...
									$sql6 = "UPDATE altruistic success = 1 WHERE key_value = '$altruistic_id'";
