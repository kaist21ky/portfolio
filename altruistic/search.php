								...
								<section>
									...
									<div class="row gtr-uniform">
											<div class="col-4 col-12-xsmall">
												<select class="js-example-basic-single" name="keyword">
											...
											<div class="col-4 col-12-xsmall">
												<input type="submit" value="검색하기" class="primary" />
											</div>
										</div>
									...
									<?php
										...
										$sql = "SELECT * FROM altruistic_success WHERE subject_name = '$keyword' AND state = 0";
