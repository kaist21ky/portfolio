...
/*
									...
									$encrypted_passwd = password_hash($user_pw, PASSWORD_DEFAULT);
									...
									$sql = "INSERT INTO user ( user_id, username, user_pw, kakao_id ) VALUES ( '$user_id', '$username', '$encrypted_passwd', '$kakao_id' )";

									$result = mysqli_query($conn,$sql);

									if($result){
										echo "성공적으로 회원가입 되었습니다";
									} else{
